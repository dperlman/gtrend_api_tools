...
def test_api_search_history(api_instance, test_terms, test_dates):
    ...
    # First search
    api_instance.search(search_term=test_terms['term1'], start_date=start_date_1, end_date=end_date_1).standardize_data()
    ...
    # Second search
    api_instance.search(search_term=test_terms['term2'], start_date=start_date_2, end_date=end_date_2).standardize_data()
    assert api_instance.data
    ...
    # Third search
    api_instance.search(search_term=test_terms['term3'], start_date=start_date_2, end_date=end_date_2).standardize_data()
    assert api_instance.data
...
def test_api_raises_when_terms_none(api_instance, test_dates):
    ...
    with pytest.raises(ValueError):
        api_instance.search(search_term=None, start_date=start_date, end_date=end_date)
...
def test_api_raises_when_start_date_none(api_instance, test_terms, test_dates):
    ...
    end_date = test_dates['short_range']['end']
    with pytest.raises(ValueError):
        api_instance.search(search_term=search_term, start_date=None, end_date=end_date)
...
def test_api_raises_when_end_date_none(api_instance, test_terms, test_dates):
    ...
    start_date = test_dates['short_range']['start']
    with pytest.raises(ValueError):
        api_instance.search(search_term=search_term, start_date=start_date, end_date=None)
