...
from gtrend_api_tools.date_strings import parse_date_str, split_date_range_str, cleanup_date_str # parse_date_str is a wrapper for dateutil.parser.parse where we set the default the way we want it
...
class DateRange:
    ...
    def _init_from_dt_pair(self, dt: Union[datetime, List[datetime], Tuple[datetime, datetime]]) -> None:
        ...
        if isinstance(dt, (list, tuple)) and len(dt) == 2 and all(isinstance(d, datetime) for d in dt):
            ...
            self.original_date_cleaned = f"{cleanup_date_str(start_date_dt.isoformat())}{self.range_space}{cleanup_date_str(end_date_dt.isoformat())}"
    ...
    def _init_from_range_str(self, date_str: str, verbose: bool = False) -> None:
        ...
        self.start_date, self.end_date = split_date_range_str(clean_date_str)
...
class SearchSpec(DateRange):
    ...
    2. With existing DateRange: SearchSpec("coffee,tea", date_range=my_date_range)
    3. Using classmethod: SearchSpec.from_date_range(my_date_range, "coffee,tea")
    """
    def __init__(
        self,
        ...
        **kwargs
        ...
        if date_range is not None:
            ...
            new_instance = self.__class__.from_date_range(date_range, search_term, **kwargs)
    ...
    @classmethod
    def from_date_range(cls, date_range: DateRange, search_term: Union[str, List[str]], **kwargs):
        """
        ...
        instance.original_date_str = date_range.original_date_str
        instance.original_date_cleaned = date_range.original_date_cleaned
        instance.start_date = date_range.start_date
        instance.end_date = date_range.end_date
        instance.start_date_dt = date_range.start_date_dt
        instance.end_date_dt = date_range.end_date_dt
        instance.start_incomplete = date_range.start_incomplete
        instance.end_incomplete = date_range.end_incomplete
        instance.formatted_range_ymd = date_range.formatted_range_ymd
        instance.formatted_range_mdy = date_range.formatted_range_mdy
        instance.granularity = date_range.granularity
    ...
    def _init_search_spec(self, search_term: Union[str, List[str]]) -> None:
        """
        Initialize SearchSpec-specific attributes.
        This method handles the common initialization logic for both __init__ and from_date_range.
